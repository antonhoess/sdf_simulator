...
class CanvasDrawer:
    ...
    def add_cur_pos_to_trace(self):
        self.trace_pos.append(self.vehicle.r)
    ...
    def add_cur_vel_to_trace(self):
        self.trace_vel.append(self.vehicle.rd * 20.0)
    ...
    def add_cur_acc_to_trace(self):
        self.trace_acc.append(self.vehicle.rdd * 1000.0)
    ...
    def add_cur_tangent_to_trace(self):
        self.trace_tangent.append(self.vehicle.rdt * 10000.0)
    ...
    def add_cur_normal_to_trace(self):
        self.trace_normal.append(self.vehicle.rdn * 10000.0)
    ...
    def add_cur_acc_times_tangent_to_trace(self):
        self.trace_acc_times_tangent.append(self.vehicle.rddxrdt * 1000.0)
    ...
    def add_cur_acc_times_normal_to_trace(self):
        self.trace_acc_times_normal.append(self.vehicle.rddxrdn * 1000.0)
